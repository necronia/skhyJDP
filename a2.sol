...
contract Ballot {
	...
	constructor(
        ...
        ERC20PresetMinterPauser addr) public {
    ...
    function ercName() public view returns (string memory name) {
        return erc.name();
    }
    
    function ercSymbol() public view returns (string memory symbol) {
        return erc.symbol();
    }
    
    function ercMint(address to, uint256 amount) public virtual
    {
        erc.mint(to, amount);
    }
